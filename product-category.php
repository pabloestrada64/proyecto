...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_product_category; ?>)">
    <div class="inner">
        <h1>Categoria de <?php echo $title; ?></h1>
    </div>
</div>
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="col-md-9">
                ...
                <h3>Todos los productos de "<?php echo $title; ?>"</h3>
                                    ...
                                    <div class="col-md-4 item item-product-cat">
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                ...
                                                <?php else: ?>
                                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i> Añadir al carrito</p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
