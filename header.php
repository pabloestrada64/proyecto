		...
		<div class="row inner">
			...
			<div class="col-md-5 right">
				<ul>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> Carrito (Bs<?php
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<div class="form-group">
						<input type="text" class="form-control search-top" placeholder="Buscar Producto" name="search_text">
					</div>
