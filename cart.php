...
if(isset($_POST['form1'])) {
    ...
    for($i=1;$i<=count($arr1);$i++) {
        ...
        if($table_quantity[$temp_index] < $arr2[$i]) {
        	$allow_update = 0;
            $error_message .= '"'.$arr2[$i].'" productos no estan disponibles para "'.$arr3[$i].'"\n';
        } else {
	...
	<?php else: ?>
		<script>alert('La actualización de la cantidad de todos los artículos es exitosa!');</script>
	<?php endif; ?>
    <?php
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    <?php echo '<h2 class="text-center">Carrito esta vacio!!</h2></br>'; ?>
				...
				<div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        <tr>
                            ...
                            <th class="text-center" style="width: 100px;"><?php echo 'Accion' ?></th>
                        </tr>
                        <?php
                        $table_total_price = 0;
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><input type="submit" value="Actualizar" class="btn btn-primary" name="form1"></li>
                        <li><a href="index.php" class="btn btn-primary">Continuar comprando</a></li>
                        <li><a href="checkout.php" class="btn btn-primary">Seguir con la compra</a></li>
                    </ul>
                </div>
                </form>
                <?php endif; ?>
