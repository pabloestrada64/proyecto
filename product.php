...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Lo siento solo esta disponible '.$current_p_qty.' item(s) en stock';
		?>
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        for($i=1;$i<=count($arr_cart_p_id);$i++) {
            ...
            $success_message1 = 'El producto fue añadido al carrito exitosamente!';
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <div class="p-quantity">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb_20">
                                        <?php echo 'Seleccione el tamaño' ?> <br>
                                    ...
                                    <?php if(isset($color)): ?>
                                    <div class="col-md-12">
                                        <?php echo 'Seleccione el color' ?> <br>
							...
							<div class="p-price">
                                <span style="font-size:14px;"><?php echo 'Precio del producto' ?></span><br>
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del>Bs <?php echo $p_old_price; ?></del>
                                    <?php endif; ?> 
                                    Bs. <?php echo $p_current_price; ?>
                                </span>
                            </div>
							...
							<div class="btn-cart btn-cart1">
                                <input type="submit" value="Añadir al carrito" name="form_add_to_cart">
							</div>
                            </form>
							<div class="share">
                                <?php echo 'Comparte este producto' ?> <br>
