...
if (isset($_POST['form1'])) {
    ...
    if( empty($_POST['cust_password']) || empty($_POST['cust_re_password']) ) {
        $valid = 0;
        $error_message .= "Ningun espacio debe estar vacio";
    }
    ...
    if($valid == 1) {
        ...
        $success_message = "La actualizacion fue exitosa";
    }
}
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo "Nueva Contraseña" ?> *</label>
                                    <input type="password" class="form-control" name="cust_password">
                                </div>
                                <div class="form-group">
                                    <label for=""><?php echo "Repita la Contraseña Nueva" ?> *</label>
