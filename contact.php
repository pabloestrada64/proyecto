                ...
                <div class="row cform">
                    <div class="col-md-8">
                        <div class="well well-sm">
                            ...
                            <?php
// Después de enviar el formulario, verifica todo para el envío de correo electrónico
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Porfavor ingrese su nombre.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Por favor ingrese su numero de telefono.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Porfavor ingrese su correo electronico.\n';
    }
    else
    {
        ...
        {
            $valid = 0;
            $error_message .= 'Porfavor ingrese un correro electronico.\n';
        }
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Porfavor ingrese su mensaje.\n';
    }
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Ingrese su correo electronico">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Numero de Telefono</label>
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Ingrese su numero de telefono">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Mensaje</label>
                                        <textarea name="visitor_message" class="form-control" rows="9" cols="25" placeholder="Ingrese el mensaje"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
