...
if (isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_email'])) {
        $valid = 0;
        $error_message .= "Email espacio no puede estar vacio. ";
    } else {
        if (filter_var($_POST['cust_email'], FILTER_VALIDATE_EMAIL) === false) {
            ...
            if($total) {
                $valid = 0;
                $error_message .= "Direccion email ya existente. ";
            }
        }
    }
    ...
    if(empty($_POST['cust_phone'])) {
        $valid = 0;
        $error_message .= "Telefono no puede estar vacio. ";
    }
    ...
    if(empty($_POST['cust_country'])) {
        $valid = 0;
        $error_message .= "Pais no puede estar vacio. ";
    }
    ...
    if( empty($_POST['cust_password']) || empty($_POST['cust_re_password']) ) {
        $valid = 0;
        $error_message .= "Contraseña no puede estar vacio";
    }
...
<a href="'.$verify_link.'">'.$verify_link.'</a>';
        ...
        $success_message = "El registro se completo. ";
    }
}
?>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn btn-danger" value="Registrar" name="form1">
                                </div>
                            </div>
                        </div>                        
                    </form>
